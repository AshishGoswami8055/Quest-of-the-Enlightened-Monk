...
function determineWinner({ player, enemy, timerID }) {
   ...
   if (player.health > enemy.health) {
        document.querySelector('#result').innerHTML = 'You Won...'; // Player's health is greater.
        setInterval(() => {
          window.close("html/index.html");
        }, 3000);
    } else {
        document.querySelector('#result').innerHTML = 'You Loose!!! 2 Attempts Left'; // Enemy's health is greater.
        setInterval(() => {
            window.open("../fighting2/html/index.html");
            window.close("html/index.html");
        }, 3000);
    }
}