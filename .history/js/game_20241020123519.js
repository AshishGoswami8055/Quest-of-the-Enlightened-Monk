...
playButton.addEventListener('click', () => {
  ...
  update();
    ...
    document.getElementById('puzzle-trigger').addEventListener('click', showPuzzle);
    // Existing showPuzzle function
    function showPuzzle() {
        createPuzzle(); // Create puzzle pieces
        puzzlePopup.style.display = 'flex'; // Show the puzzle popup
    }
