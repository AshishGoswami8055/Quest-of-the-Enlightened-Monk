...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function handleCollision() {
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      // Example of collision detection to trigger the meditation
      const meditationObj = document.querySelectorAll('.meditation'); // Adjust according to your logic
      meditationObj.forEach((obj) => {
          if (checkCollision(player, obj.querySelector('img')) && !obj.classList.contains('fade-out')) {
              triggerMeditation(); // Call the function to show the popup
          }
      });
