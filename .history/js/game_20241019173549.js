  ...
  update();
   ...
   // Close button functionality
    ...
    closeButton.addEventListener('click', () => {
        document.querySelector(".meditation-container").style.visibility = "hidden";
        meditationVideo.pause(); // Pause video when popup is closed
        meditationVideo.currentTime = 0; // Reset video to the start
    });
