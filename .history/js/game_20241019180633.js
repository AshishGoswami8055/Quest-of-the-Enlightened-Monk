...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function handleCollision() {
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      playButton.addEventListener('click', () => {
        if (meditationVideo) { // Ensure meditationVideo is defined
            meditationVideo.play(); // Play the video
        }
    });    
      ...
      pauseButton.addEventListener('click', () => {
        if (meditationVideo) { // Ensure meditationVideo is defined
            meditationVideo.pause(); // Pause the video
        }
    });    
    ...
    closeButton.addEventListener('click', () => {
      ...
      // Hide the popup by setting display to 'none' or visibility to 'hidden'
      meditationContainer.style.display = 'none'; // Or use visibility: 'hidden
  });
  ...
  update();
    ...
    meditationButton.addEventListener('click', function() {
      ...
      const audio = new Audio('audio/meditation.mp4');
      console.log(audio); // Check if audio object is created correctly
      audio.play().then(() => {
