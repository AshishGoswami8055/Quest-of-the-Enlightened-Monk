...
document.addEventListener("DOMContentLoaded", () => {
  ...
  update();
    ...
    document.getElementById('closeButton').addEventListener('click', () => {
        ...
        // Additional close functionality here
    });

     // You can show the meditation container by setting its visibility to 'visible' when needed
     function showMeditationPopup() {
      meditationContainer.style.visibility = 'visible';
  }
