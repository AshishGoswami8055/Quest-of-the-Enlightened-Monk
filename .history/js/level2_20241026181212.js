...
function displayResults() {
  ...
  // Update the question number display to indicate completion
  ...
  // Clear options for the next question
  optionsContainer.innerHTML = "";
  
  // Hide the next button as the quiz is complete
  nextButton.style.display = "none";
  
  // Show the scoreboard container with the results
  scoreboardContainer.style.display = "block";
  
  // Render the scoreboard with user answers
  renderScoreboard();
...
function renderScoreboard() {
  ...
  userAnswers.forEach((answer, index) => {
    ...
    // Populate the cells with question number, user's answer, and correct answer
