...
(function () {
  ...
  const overlay = document.querySelector('.overlay'); // Overlay for popups
  const ticTacToeContainer = document.querySelector('.tictactoe-container'); // Tic-Tac-Toe container
  ...
  // Function to display the Tic-Tac-Toe game
  ...
  const displaySunflowerPopup = (message) => {
    ...
    // Trigger Tic-Tac-Toe popup after sunflower interaction
    triggerTicTacToePopup();
  };
