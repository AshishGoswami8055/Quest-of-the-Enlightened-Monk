...
// Updates the player's score and golden energy display
function updateScore() {
  scoreElement.textContent = "Score : " + score; // Display score
  goldenElement.textContent = "Golden Energies : " + golden_Energy; // Display golden energies
}
...
const quizData = [
{
  question: "What is the primary focus of Buddha's teachings?",
  options: [
    "Material wealth",
  ...
  correct: "Overcoming ignorance and suffering"
},
{
  question: "What does the 'Middle Way' refer to in Buddhism?",
  options: [
    "A path between extremes of indulgence and asceticism",
    "A balanced diet",
    "A journey through life",
    "A type of meditation"
  ],
  correct: "A path between extremes of indulgence and asceticism"
},
{
  question: "According to Buddha, what is the root cause of suffering?",
  options: [
  ...
  correct: "Desire and attachment"
},
  {
    question: "I turn every deed, good or bad, into a cosmic invoice. Payable now or later. What am I?",
    options: [
      "Destiny",
      "Karma",
      "Luck",
  ...
  {
    question: "Through me, you might find peace or answers as you sit quietly, exploring the inner cosmos. What am I?",
    options: [
      "Reflection",
      "Meditation",
      "Contemplation",
  ...
  {
    question: "I am you. Yet I am just a tiny piece of you. I can become as large as a mountain, yet I am as fragile as a bubble. Who am I?",
    options: [
      "Yourself",
      "Mind",
      "Ego",
  ...
  },
  {
    ...
    correct: "40-50" // Assuming this is the correct answer; modify as necessary
  }
