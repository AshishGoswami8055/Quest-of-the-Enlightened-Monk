...
// Function to show the meditation popup
function showMeditationPopup() {
    ...
    console.log('Showing popup and playing video');
}

// Example: Call this function to show the popup when needed
function detectCollisionAndShowPopup() {
    ...
    meditationObj.forEach((obj) => {
        if (checkCollision(player, obj.querySelector('img')) && !obj.classList.contains('fade-out')) {
            showMeditationPopup(); // Call this function to show the popup
        }
    });
}
...
// Call this function to check for collision
detectCollisionAndShowPopup();
