...
function checkCompletion() {
    ...
    if (completed) {
        ...
        if (currentPuzzle === 1) {
            ...
            currentPuzzle = 2; // Move to the next puzzle
            ...
            currentPuzzle = 3; // Move to the next puzzle
...
function gameOver() {
    ...
    // Add a restart button to reload the puzzle
    let restartButton = document.createElement("button");
    restartButton.innerText = "Restart Puzzle";
