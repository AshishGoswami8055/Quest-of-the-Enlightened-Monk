...
function checkCompletion() {
    ...
    if (completed) {
        if (currentPuzzle === 1) {
            ...
            console.log("Congratulations for completing level 3! Your answer is Ego!");
            document.getElementById("message").innerText = "Congratulations for completing level 3! Your answer is Ego!";
        }
    } else {
