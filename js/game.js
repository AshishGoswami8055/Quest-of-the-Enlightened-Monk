...
let isNight = true; // Initially set to night
...
function startCollisionChecks() {
  ...
  setInterval(checkHarmfulObjectCollisions, 100);
    ...
    snake.forEach((obj) => {
      if (
        checkCollision(player, obj.querySelector("img")) && // Check if player collides
        !obj.classList.contains("fade-out") && // Ensure object is not fading out
        !obj.classList.contains("snakeVisibility") && // Ignore hidden snakes
        invincibility == false // Ensure player is not invincible
      ) {
        updatePlayerImage("Hit"); // Update player's image to "Hit"
  ...
  const quizData = [
    {
      question: "How does the First Noble Truth teach you to react to difficulties in life?",
      options: [
        "Accept that difficulties are part of life and work to understand your feelings",
        "Avoid the situation to end suffering",
        "Ignore the suffering and move on"
      ],
      correct: "Accept that difficulties are part of life and work to understand your feelings"
    },
    {
      question: "According to the Second Noble Truth, what is a wise way to respond when your expectations lead to frustration?",
      options: [
        "Reflect on how your expectations may be causing frustration and work to let go of them",
        "Focus on convincing others to follow your plans more closely",
        "Avoid interacting with those who don’t align with your goals"
      ],
      correct: "Reflect on how your expectations may be causing frustration and work to let go of them"
    }
    ,
    {
